          ...
          >
            <div className="max-w-md w-full space-y-8">
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 bg-ku-green/10 blur-3xl rounded-full" />
                <img 
                  src="https://upload.wikimedia.org/wikipedia/th/5/51/Logo_ku_th.svg" 
                  alt="Kasetsart University Logo" 
                  className="relative w-48 h-48 sm:w-64 sm:h-64 object-contain mx-auto"
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-ku-soft text-ku-green text-xs font-bold mb-4">
                    <Sparkles size={12} />
                  ...
                  <p className="text-slate-500 mt-4 leading-relaxed">
                    ยินดีต้อนรับสู่ระบบช่วยเหลือนิสิตอัจฉริยะ<br />
                    พร้อมตอบทุกคำถามเกี่ยวกับมหาวิทยาลัยเกษตรศาสตร์
                  </p>
                </motion.div>
                ...
                <motion.button
                  ...
                  className="mt-8 px-10 py-4 bg-ku-green text-white rounded-full font-bold text-lg shadow-xl shadow-ku-green/20 hover:bg-ku-light transition-all flex items-center gap-3 mx-auto"
                >
                  Start now
                  <Send size={20} />
                </motion.button>
              ...
              <motion.p
                ...
                className="text-[10px] text-slate-400 pt-12 uppercase tracking-[0.2em]"
              >
                Knowledge of the Land • Since 1943
              </motion.p>
            </div>
          </motion.div>
        ) : (
            ...
            <aside className={cn(
              ...
              <div className="flex flex-col h-full">
                <div className="p-6 flex items-center gap-3 border-b border-slate-50">
                  ...
                  <span className="font-bold text-slate-800 text-lg">Kasetsart Assistant</span>
                </div>
                  ...
                  <div className="pt-8 border-t border-slate-50">
                    ...
                    <div className="space-y-4">
                      <a href="https://www.ku.ac.th" target="_blank" rel="noreferrer" className="flex items-center justify-between text-sm text-slate-600 hover:text-ku-green transition-colors">
                        เว็บไซต์หลัก Kasetsart <ExternalLink size={14} className="text-slate-400" />
                      </a>
                      ...
                      <a href="https://fna.csc.ku.ac.th/grade/" target="_blank" rel="noreferrer" className="flex items-center justify-between text-sm text-slate-600 hover:text-ku-green transition-colors">
                        เว็บคำนวนเกรด <ExternalLink size={14} className="text-slate-400" />
                      </a>
                      <a href="https://regis.src.ku.ac.th/res/table_test/index.php?fbclid=PARlRTSAQdPN5leHRuA2FlbQIxMABzcnRjBmFwcF9pZA8xMjQwMjQ1NzQyODc0MTQAAadxiyvhI7ZmHIzE5SDvN5tJl6x0izgXnN6DfeKbiKNeNLCuoTliEHze98v77A_aem_3TJd3Y9RuYCplYZC0kskPg" target="_blank" rel="noreferrer" className="flex items-center justify-between text-sm text-slate-600 hover:text-ku-green transition-colors">
                        ค้นหาตารางสอบ <ExternalLink size={14} className="text-slate-400" />
                      </a>
                    </div>
                  </div>
                </div>
